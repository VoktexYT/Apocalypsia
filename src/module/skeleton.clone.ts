...
import { Object3D, SkinnedMesh, Bone, Skeleton, InstancedMesh } from 'three';
...
export function clone_instancedMesh(source: InstancedMesh): InstancedMesh {
    const sourceLookup = new Map<Object3D, Object3D>();
    const cloneLookup = new Map<Object3D, Object3D>();

    const clone = source.clone() as InstancedMesh;
